...
//https://en.wikipedia.org/wiki/Distance-vector_routing_protocol Used wiki diagram to analyze the similarities for each node to generalize code to work for all 

public class Entity0 extends Entity
{    
	private int nodenum = 0; //only thing that is changed between entities
    ...
    {    
		...
		{			
			for(int i = 0; i < NetworkSimulator.NUMENTITIES; i++)
			{
				...
				NetworkSimulator.toLayer2(new Packet(nodenum, i, mincostTemp)); //nodenum or source?
			}
			printDT();
		}
    }
